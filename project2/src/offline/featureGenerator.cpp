...
the type of feature to extract (e.g., "baseline", "gabor"), and the output file path
...
int main(int argc, char *argv[])
{
    ...
    for (const auto &featureStr : args.featureStrs)
    {
        ...
        // create the appropriate feature extractor based on the feature type and position
